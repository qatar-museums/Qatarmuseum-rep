<?php
  if (isset($item['link']['options']) && is_array($item['link']['options'])) {
...
<li <?php print $attributes;?> class="<?php print $classes;?>">
  <a href="<?php print in_array($item['link']['href'], array('<nolink>')) ? "#" : url($item['link']['href'], $options);?>" <?php echo drupal_attributes($item['link']['#attributes']); ?>>
