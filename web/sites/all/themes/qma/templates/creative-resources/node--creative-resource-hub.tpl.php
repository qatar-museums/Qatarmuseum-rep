...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <div id="resources-list">
    <?php print $resources_list; ?>
  </div>

  <?php if ($content['field_featured_resource']): ?>
  <div class="full-width orange">

    <div class="container">

      <?php print render($content['field_featured_resource']); ?> 
  ...
  <div class="full-width grey">
    ...
    <div class="container full-width-form content-form">
      ...
      <?php print render($content['resource_question_form']); ?>
