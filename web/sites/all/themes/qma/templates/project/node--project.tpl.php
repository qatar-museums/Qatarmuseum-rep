...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <?php if ($content['field_participation_promo_ref'] || $content['field_featured_conversation']): ?>
    ...
    <div class="content container no-padding-bottom"<?php print $content_attributes; ?>>
        ...
        <?php print render($content['field_featured_conversation']); ?>
    ...
    <div class="container">
      ...
      <div class="column first">
        <?php if(isset($content['field_find_out_more_links'])): ?>
          ...
          <?php print render($content['field_project_primary_link']); ?>
        <?php endif; ?>
      </div>

      <?php if(isset($content['field_area_of_work']) || isset($content['field_project_sample_tags'])): ?>
        <div class="column">
          <h2><?php print t('See also', array(), array('context' => 'QMA')); ?></h2>
          <?php print render($content['field_area_of_work']); ?> 
